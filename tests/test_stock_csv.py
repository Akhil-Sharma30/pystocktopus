...
def test_csv_data_reader():
    assert CSVDataHandler.csv_data_reader(user_csv_file, column_ticker_name) == ticker_values
    assert CSVDataHandler.csv_data_reader(user_csv_file, column_amount_name) == amount_values
