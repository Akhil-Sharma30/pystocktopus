(self.webpackChunkjupyterlab_plotly =
  ...
  [423],
  {
    423: (e, t, n) => {
      ...
      const i = "application/vnd.plotly.v1+json";
      class s extends o.Widget {
        constructor(e) {
          super(),
            this.addClass("jp-RenderedPlotly"),
            ...
            this._img_el.addEventListener("mouseenter", (e) => {
              this.createGraph(this._model);
            });
        }
        renderModel(e) {
          if (this.hasGraphElement()) return Promise.resolve();
          this._model = e;
          const t = e.data["image/png"];
          return null != t
            ? (this.updateImage(t), Promise.resolve())
            : this.createGraph(e);
        }
        hasGraphElement() {
          return null !== this.node.querySelector(".plot-container");
        }
        updateImage(e) {
          this.hideGraph(),
            (this._img_el.src = "data:image/png;base64," + e),
            this.showImage();
        }
        hideGraph() {
          let e = this.node.querySelector(".plot-container");
        ...
        hideImage() {
          let e = this.node.querySelector(".plot-img");
          null != e && (e.style.display = "none");
        }
        showImage() {
          let e = this.node.querySelector(".plot-img");
          ...
          return (
            ...
            (() =>
              l(this, void 0, void 0, function* () {
                return (
                  null === s.Plotly &&
                    ((s.Plotly = yield n.e(478).then(n.t.bind(n, 478, 23))),
                    s._resolveLoadingPlotly()),
                  s.loadingPlotly
                );
              }))()
              .then(() => s.Plotly.react(this.node, t, o, r))
              .then((t) => {
                this.showGraph(),
                  this.hideImage(),
                  this.update(),
                  i && s.Plotly.addFrames(this.node, i),
                  this.node.offsetWidth > 0 &&
                  ...
                  this.node.on("plotly_webglcontextlost", () => {
                    const t = e.data["image/png"];
                    if (null != t)
                      return this.updateImage(t), Promise.resolve();
                  });
              })
          );
        }
        ...
        onUpdateRequest(e) {
          s.Plotly &&
            ...
            s.Plotly.redraw(this.node).then(() => {
              s.Plotly.Plots.resize(this.node);
            });
        }
      }
      (s.Plotly = null),
        (s.loadingPlotly = new Promise((e) => {
          s._resolveLoadingPlotly = e;
        }));
      const r = { safe: !0, mimeTypes: [i], createRenderer: (e) => new s(e) },
        a = [
          {
            ...
            fileTypes: [
              {
                ...
                iconClass: "jp-MaterialIcon jp-PlotlyIcon",
              },
            ],
    ...
    549: (e, t, n) => {
      ...
      "string" == typeof (l = l.__esModule ? l.default : l) &&
        (l = [[e.id, l, ""]]);
      o(l, { insert: "head", singleton: !1 }), (e.exports = l.locals || {});
    },
    379: (e, t, n) => {
      "use strict";
      var o,
      ...
      function r(e, t) {
        for (var n = {}, o = [], l = 0; l < e.length; l++) {
          ...
          -1 !== h
            ? (i[h].references++, i[h].updater(u))
            : i.push({ identifier: d, updater: y(u, t), references: 1 }),
            o.push(d);
        }
        return o;
      }
      ...
      function h(e, t, n, o) {
        var l = n
          ...
          : o.media
            ...
            : o.css;
        if (e.styleSheet) e.styleSheet.cssText = d(t, l);
        else {
      ...
      e.exports = function (e, t) {
        ...
        return function (e) {
          if (
            ...
            for (var a = r(e, t), c = 0; c < n.length; c++) {
              var d = s(n[c]);
